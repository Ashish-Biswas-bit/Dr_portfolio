...
const testimonials = [
  { name: "Michael R.", text: "Dr. Johnson saved my life. Her expertise and care during my emergency procedure was exceptional." },
  { name: "Susan K.", text: "After years of struggling with heart issues, Dr. Johnson finally provided answers and effective treatment." },
...
export default function Home() {
  return (
    <main className={clsx('min-h-screen', 'bg-white')}>
        ...
        <div className={clsx('max-w-7xl', 'mx-auto', 'px-6', 'py-4')}>
          <div className={clsx('flex', 'items-center', 'justify-between')}>
            <div className={clsx('flex', 'items-center', 'gap-3')}>
              ...
              <span className={clsx('font-semibold', 'text-slate-800')}>Dr. Michael Chen</span>
            </div>
      ...
      {/* Hero Section */}
      <section className={clsx('pt-32', 'pb-20', 'px-6', 'bg-gradient-to-br', 'from-slate-50', 'via-white', 'to-teal-50')}>
        <div className={clsx('max-w-7xl', 'mx-auto')}>
          <div className={clsx('grid', 'md:grid-cols-2', 'gap-16', 'items-center')}>
            <div>
              ...
              <div className={clsx('flex', 'flex-wrap', 'gap-4')}>
                <a href="#contact" className={clsx('bg-teal-600', 'text-white', 'px-8', 'py-4', 'rounded-full', 'font-semibold', 'hover:bg-teal-700', 'transition-colors', 'inline-flex', 'items-center', 'gap-2')}>
                  Schedule Consultation
                  <svg className={clsx('w-5', 'h-5')} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
                </a>
                <a href="#services" className={clsx('border-2', 'border-slate-300', 'text-slate-700', 'px-8', 'py-4', 'rounded-full', 'font-semibold', 'hover:border-teal-600', 'hover:text-teal-600', 'transition-colors')}>
                  Our Services
                </a>
              </div>
            </div>
            <div className={clsx('relative', 'animate-slide-in-right', 'delay-200')}>
              <div className={clsx('w-80', 'h-80', 'md:w-96', 'md:h-96', 'mx-auto', 'bg-gradient-to-br', 'from-teal-100', 'to-teal-200', 'rounded-full', 'flex', 'items-center', 'justify-center', 'p-4')}>
                <img
                  src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&h=400&fit=crop&crop=face"
                  alt="Dr. Michael Chen"
                  className={clsx('w-64', 'h-64', 'md:w-80', 'md:h-80', 'rounded-full', 'shadow-2xl', 'object-cover', 'border-4', 'border-white')}
                />
              </div>
              <div className={clsx('absolute', '-bottom-4', 'left-1/2', 'transform', '-translate-x-1/2', 'bg-white', 'px-6', 'py-3', 'rounded-2xl', 'shadow-xl', 'animate-float')}>
                <div className={clsx('flex', 'items-center', 'gap-3')}>
          ...
          <div className={clsx('grid', 'grid-cols-2', 'md:grid-cols-4', 'gap-6', 'mt-20')}>
            {[
              ...
              <div key={i} className={clsx('bg-white', 'p-6', 'rounded-2xl', 'shadow-lg', 'border', 'border-slate-100', 'text-center', 'animate-fade-in-up', 'hover:scale-105', 'transition-transform', 'duration-300')} style={{animationDelay: `${i * 0.1}s`}}>
                <p className={clsx('text-3xl', 'font-bold', 'text-teal-600', 'mb-1')}>{stat.value}</p>
                <p className={clsx('text-slate-600', 'text-sm')}>{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className={clsx('grid', 'md:grid-cols-2', 'gap-16', 'items-center')}>
            <div className={clsx('bg-gradient-to-br', 'from-slate-100', 'to-slate-200', 'rounded-3xl', 'p-12', 'animate-slide-in-left')}>
              <div className="space-y-6">
                <div className={clsx('bg-white', 'p-6', 'rounded-2xl', 'shadow-lg')}>
                  <div className={clsx('flex', 'items-start', 'gap-4')}>
                    <div className={clsx('w-12', 'h-12', 'bg-teal-100', 'rounded-xl', 'flex', 'items-center', 'justify-center', 'flex-shrink-0')}>
                      <svg className={clsx('w-6', 'h-6', 'text-teal-600')} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                      </svg>
                    </div>
                    <div>
                      <h4 className={clsx('font-semibold', 'text-slate-900', 'mb-1')}>Board Certified</h4>
                ...
                <div className={clsx('bg-white', 'p-6', 'rounded-2xl', 'shadow-lg')}>
                  <div className={clsx('flex', 'items-start', 'gap-4')}>
                    ...
                    <div>
                      <h4 className={clsx('font-semibold', 'text-slate-900', 'mb-1')}>Top Hospital</h4>
                ...
                <div className={clsx('bg-white', 'p-6', 'rounded-2xl', 'shadow-lg')}>
                  <div className={clsx('flex', 'items-start', 'gap-4')}>
                    ...
                    <div>
                      <h4 className={clsx('font-semibold', 'text-slate-900', 'mb-1')}>Published Researcher</h4>
            ...
            <div className="animate-slide-in-right">
              ...
              <div className={clsx('flex', 'flex-wrap', 'gap-4')}>
                <span className={clsx('bg-slate-100', 'text-slate-700', 'px-4', 'py-2', 'rounded-full', 'text-sm', 'font-medium')}>Interventional Cardiology</span>
                <span className={clsx('bg-slate-100', 'text-slate-700', 'px-4', 'py-2', 'rounded-full', 'text-sm', 'font-medium')}>Heart Failure</span>
                <span className={clsx('bg-slate-100', 'text-slate-700', 'px-4', 'py-2', 'rounded-full', 'text-sm', 'font-medium')}>Preventive Care</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={clsx('max-w-7xl', 'mx-auto')}>
          ...
          <div className={clsx('grid', 'md:grid-cols-2', 'lg:grid-cols-3', 'gap-8')}>
            {services.map((service, i) => (
              <div key={i} className={clsx('bg-white', 'p-8', 'rounded-2xl', 'shadow-lg', 'hover:shadow-xl', 'transition-all', 'duration-300', 'group', 'animate-fade-in-up', 'hover:-translate-y-2')} style={{animationDelay: `${i * 0.1}s`}}>
                <div className={clsx('w-14', 'h-14', 'bg-slate-100', 'rounded-2xl', 'flex', 'items-center', 'justify-center', 'mb-6', 'group-hover:bg-teal-600', 'transition-colors')}>
                  <svg className={clsx('w-7', 'h-7', 'text-slate-600', 'group-hover:text-white', 'transition-colors')} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={service.icon} />
                  </svg>
                </div>
                <h3 className={clsx('text-xl', 'font-semibold', 'text-slate-900', 'mb-3')}>{service.title}</h3>
      ...
      <section id="experience" className={clsx('py-24', 'px-6')}>
        <div className={clsx('max-w-7xl', 'mx-auto')}>
          ...
          <div className={clsx('max-w-4xl', 'mx-auto')}>
            {education.map((edu, i) => (
              <div key={i} className={clsx('flex', 'gap-8', 'mb-12', 'last:mb-0', 'animate-fade-in-up')} style={{animationDelay: `${i * 0.15}s`}}>
                <div className={clsx('flex', 'flex-col', 'items-center')}>
                  <div className={clsx('w-4', 'h-4', 'bg-teal-600', 'rounded-full')}></div>
                  {i !== education.length - 1 && <div className={clsx('w-0.5', 'flex-1', 'bg-slate-200', 'mt-2')}></div>}
                </div>
                <div className={clsx('flex-1', 'pb-12')}>
                  <span className={clsx('text-teal-600', 'font-semibold', 'text-sm')}>{edu.year}</span>
                  <h3 className={clsx('text-xl', 'font-semibold', 'text-slate-900', 'mt-1')}>{edu.title}</h3>
        ...
        <div className={clsx('max-w-7xl', 'mx-auto')}>
          ...
          <div className={clsx('grid', 'md:grid-cols-3', 'gap-8')}>
            {testimonials.map((t, i) => (
              <div key={i} className={clsx('bg-white/10', 'backdrop-blur-sm', 'p-8', 'rounded-2xl', 'animate-fade-in-up', 'hover:bg-white/20', 'transition-all', 'duration-300')} style={{animationDelay: `${i * 0.15}s`}}>
                <div className={clsx('flex', 'gap-1', 'mb-4')}>
                  {[1,2,3,4,5].map(s => (
                    <svg key={s} className={clsx('w-5', 'h-5', 'text-yellow-400', 'fill-current')} viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  ))}
                </div>
                <p className={clsx('text-white/90', 'mb-6', 'italic')}>"{t.text}"</p>
                <p className={clsx('text-white', 'font-semibold')}>— {t.name}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className={clsx('grid', 'md:grid-cols-2', 'gap-16')}>
            <div className="animate-slide-in-left">
              ...
              <p className={clsx('text-slate-600', 'mb-8')}>
                Take the first step toward better heart health. Schedule a consultation with Dr. Johnson today.
              </p>
              <div className="space-y-6">
                <div className={clsx('flex', 'items-center', 'gap-4')}>
                  <div className={clsx('w-12', 'h-12', 'bg-teal-100', 'rounded-xl', 'flex', 'items-center', 'justify-center')}>
                    <svg className={clsx('w-6', 'h-6', 'text-teal-600')} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <div>
                    <p className={clsx('text-sm', 'text-slate-500')}>Phone</p>
                    <p className={clsx('font-semibold', 'text-slate-900')}>+880 1XXXXXXXX</p>
                  </div>
                </div>
                <div className={clsx('flex', 'items-center', 'gap-4')}>
                  <div className={clsx('w-12', 'h-12', 'bg-teal-100', 'rounded-xl', 'flex', 'items-center', 'justify-center')}>
                  ...
                  <div>
                    <p className={clsx('text-sm', 'text-slate-500')}>Email</p>
                    <p className={clsx('font-semibold', 'text-slate-900')}>appointments@drjohnson.md</p>
                  </div>
                </div>
                <div className={clsx('flex', 'items-center', 'gap-4')}>
                  <div className={clsx('w-12', 'h-12', 'bg-teal-100', 'rounded-xl', 'flex', 'items-center', 'justify-center')}>
                  ...
                  <div>
                    <p className={clsx('text-sm', 'text-slate-500')}>Address</p>
                    <p className={clsx('font-semibold', 'text-slate-900')}>123 Medical Center Dr, Dhaka, Bangladesh</p>
                  </div>
                </div>
              </div>
            </div>
            <div className={clsx('bg-slate-50', 'p-8', 'rounded-3xl', 'animate-slide-in-right')}>
              <form className="space-y-6">
                <div className={clsx('grid', 'md:grid-cols-2', 'gap-6')}>
                  <input type="text" placeholder="First Name" className={clsx('w-full', 'px-4', 'py-3', 'rounded-xl', 'border', 'border-slate-200', 'focus:border-teal-500', 'focus:ring-2', 'focus:ring-teal-200', 'outline-none', 'transition-all')} />
                  <input type="text" placeholder="Last Name" className={clsx('w-full', 'px-4', 'py-3', 'rounded-xl', 'border', 'border-slate-200', 'focus:border-teal-500', 'focus:ring-2', 'focus:ring-teal-200', 'outline-none', 'transition-all')} />
                </div>
                <input type="email" placeholder="Email Address" className={clsx('w-full', 'px-4', 'py-3', 'rounded-xl', 'border', 'border-slate-200', 'focus:border-teal-500', 'focus:ring-2', 'focus:ring-teal-200', 'outline-none', 'transition-all')} />
                <input type="tel" placeholder="Phone Number" className={clsx('w-full', 'px-4', 'py-3', 'rounded-xl', 'border', 'border-slate-200', 'focus:border-teal-500', 'focus:ring-2', 'focus:ring-teal-200', 'outline-none', 'transition-all')} />
                <textarea placeholder="Your Message" rows={4} className={clsx('w-full', 'px-4', 'py-3', 'rounded-xl', 'border', 'border-slate-200', 'focus:border-teal-500', 'focus:ring-2', 'focus:ring-teal-200', 'outline-none', 'transition-all', 'resize-none')}></textarea>
                <button type="submit" className={clsx('w-full', 'bg-teal-600', 'text-white', 'py-4', 'rounded-xl', 'font-semibold', 'hover:bg-teal-700', 'transition-colors')}>
                  Send Message
                </button>
              </form>
            </div>
        ...
        <div className={clsx('max-w-7xl', 'mx-auto')}>
          <div className={clsx('flex', 'flex-col', 'md:flex-row', 'justify-between', 'items-center', 'gap-6')}>
            <div className={clsx('flex', 'items-center', 'gap-3')}>
              ...
              <span className={clsx('font-semibold', 'text-white')}>Dr. Michael Chen</span>
            </div>
            <p className="text-sm">© 2024 Dr. Michael Chen. All rights reserved.</p>
